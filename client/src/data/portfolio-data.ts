...
import fitfreak5 from "@/assets/fitfreak/5.jpeg";
import fitfreak6 from "@/assets/fitfreak/6.jpeg";
import fitfreak7 from "@/assets/fitfreak/7.jpeg";
import fitfreak8 from "@/assets/fitfreak/8.jpeg";
import fitfreak9 from "@/assets/fitfreak/9.jpeg";
import fitfreak10 from "@/assets/fitfreak/10.jpeg";
...
export const portfolioData = {
  ...
  testimonials: [
    {
      name: "Ken",
      context: "Member-to-member network in Lovable",
      rating: 5,
      quote: "Working with Sher on his first Upwork project was an absolute pleasure. From the start, he took the time to fully understand our requirements and delivered an outstanding first module for our member-to-member network using Vibe coding through Lovable. His attention to detail, proactive testing, and clear communication at every stage made the entire process smooth and effective. Sher consistently went above and beyond to ensure both functionality and design were exceptional. I highly recommend him as a reliable, skilled, and dedicated freelancer we'd be happy to work with again."
    },
    {
      name: "Willyzd",
      context: "OpticalFit MVP",
      rating: 5,
      quote: "Working with SherAli has been a pleasure. He went above and beyond and provided a clean UI for my OpticalFit MVP. His attention to detail and clean code is what I liked about him. Will be happy to hire him again in the future."
    }
  ],
